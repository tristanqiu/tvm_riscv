...
class CodegenRVX : public MemoizedExprTranslator<std::vector<Output>>, public CodegenCBase {
 public:
  ...
  std::vector<Output> VisitExpr_(const ConstantNode* cn) final {
    ...
    // runtime.
    std::string const_symbol = "rvx_" + ext_func_id_;
...
TVM_REGISTER_GLOBAL("relay.ext.rvx.constant_updater").set_body_typed(DNNLConstantUpdaterFunc);
